    ...
    <div class="experiences">
        ...
        <div class="advanced">
            ...
            <div class="advanced-col">
                <Saos once={true} animation={'scale-up-center 0.6s cubic-bezier(.39,.575,.565,1.000) both'}>
                ...
                <Saos once={true} animation={'scale-up-center 0.8s cubic-bezier(.39,.575,.565,1.000) both'}>
                    <svg width="{svgSize}" height="{svgSize}" viewBox="0 0 128 128">
        ...
        <div class="intermediate">
            ...
            <div class="intermediate-col">
                <Saos once={true} animation={'scale-up-center 1s cubic-bezier(.39,.575,.565,1.000) both'}>
                    <svg width="{svgSize}" height="{svgSize}" viewBox="0 0 128 128">
                ...
                <Saos once={true} animation={'scale-up-center 1.2s cubic-bezier(.39,.575,.565,1.000) both'}>
                    <svg width="{svgSize}" height="{svgSize}" viewBox="0 0 128 128">
                ...
                <Saos once={true} animation={'scale-up-center 1.4s cubic-bezier(.39,.575,.565,1.000) both'}>
                    <svg width="{svgSize}" height="{svgSize}" viewBox="0 0 128 128">
                ...
                <Saos once={true} animation={'scale-up-center 1.6s cubic-bezier(.39,.575,.565,1.000) both'}>
                    <svg width="{svgSize}" height="{svgSize}" viewBox="0 0 128 128">
                ...
                <Saos once={true} animation={'scale-up-center 1.8s cubic-bezier(.39,.575,.565,1.000) both'}>
                    <svg width="{svgSize}" height="{svgSize}" viewBox="0 0 128 128">
                ...
                <Saos once={true} animation={'scale-up-center 2s cubic-bezier(.39,.575,.565,1.000) both'}>
                    <svg width="{svgSize}" height="{svgSize}" viewBox="0 0 128 128">
        ...
        <div class="beginner">
            ...
            <div class="beginner-col">
                <Saos once={true} animation={'scale-up-center 2.2s cubic-bezier(.39,.575,.565,1.000) both'}>
                    <svg width="{svgSize}" height="{svgSize}" viewBox="0 0 128 128">
                ...
                <Saos once={true} animation={'scale-up-center 2.4s cubic-bezier(.39,.575,.565,1.000) both'}>
                    <svg width="{svgSize}" height="{svgSize}" viewBox="0 0 128 128">
                ...
                <Saos once={true} animation={'scale-up-center 2.6s cubic-bezier(.39,.575,.565,1.000) both'}>
                    <svg width="{svgSize}" height="{svgSize}" viewBox="0 0 128 128">
...
<style>
    ...
    /* ----------------------------------------------
    * Generated by Animista on 2021-10-6 15:1:14
